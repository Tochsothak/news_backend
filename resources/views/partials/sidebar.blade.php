...
<aside
    :class="{
        ...
        'w-64 lg:w-20': sidebarCollapsed
    }"
    class="fixed inset-y-0 left-0 z-50 flex h-screen transform flex-col border-r border-border bg-card transition-all duration-300 ease-in-out lg:relative lg:z-auto"
    @keydown.escape.window="sidebarOpen = false">

    {{-- Logo Section --}}
    <div class="flex h-16 items-center border-b border-border px-6 transition-all duration-300"
        :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
        <a href="{{ url('/') }}" class="flex items-center gap-3 overflow-hidden">
            <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-primary transition-all">
                <span class="text-sm font-bold text-primary-foreground">PPI</span>
            </div>
            <span class="whitespace-nowrap text-lg font-semibold text-foreground transition-all duration-300"
    ...
    {{-- Navigation Menu --}}
    <nav class="flex-1 overflow-y-auto overflow-x-hidden overscroll-contain p-4 transition-all" x-data="{
        openMenus: {
        ...
        ======================================== --}}
        <div class="mb-6">
            <p class="mb-2 px-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground whitespace-nowrap transition-all duration-300"
                :class="sidebarCollapsed ? 'lg:h-0 lg:opacity-0 lg:overflow-hidden lg:m-0' : 'opacity-100'">
                Main Menu
            </p>
            ...
            <a href="{{ url('/') }}" title="Dashboard"
                ...
                :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                <i class="ph-bold ph-house text-lg shrink-0"></i>
                <span class="whitespace-nowrap transition-all duration-300"
                    :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Dashboard</span>
            </a>
            ...
            <div class="mt-1">
                <button
                    ...
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-article text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Articles</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.articles, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-microphone text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Podcasts</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.podcasts, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-video text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Videos</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.videos, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-folders text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Categories</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.categories, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-file-text text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Pages</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.pages, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
        ...
        <div class="mb-6">
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-chat-circle text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Comments</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.comments, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
            ...
            <div class="mt-1">
                <button
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Advertisements</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.ads, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-envelope text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Newsletter</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.newsletter, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
        ...
        <div class="mb-6">
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-users text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Users</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.users, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
        ...
        <div class="mb-6">
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-paint-brush text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Appearance</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.appearance, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
        ...
        <div class="mb-6">
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-chart-line text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Analytics</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.analytics, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-chart-bar text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Reports</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.reports, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
        ...
        <div class="mb-6">
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-gear text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Settings</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.settings, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-plugs text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Integrations</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.integrations, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
            ...
            <div class="mt-1">
                <button
                    ...
                    :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                    <div class="flex items-center gap-3">
                        <i class="ph-bold ph-database text-lg shrink-0"></i>
                        <span class="whitespace-nowrap transition-all duration-300"
                            :class="sidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:overflow-hidden' : 'opacity-100'">Backup</span>
                    </div>
                    <i class="ph-bold ph-caret-down text-sm shrink-0 transition-transform duration-200"
                        :class="{ 'rotate-180': openMenus.backup, 'lg:hidden': sidebarCollapsed }"></i>
                </button>
