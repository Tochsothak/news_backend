{{-- Header Navigation --}}
<header class="sticky top-0 z-40 flex h-16 items-center border-b border-border bg-card px-6 transition-all duration-300">
    <div class="flex flex-1 items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            ...
            <button type="button"
                {{-- On mobile, open the sidebar. On desktop, toggle the collapsed state --}}
                ...
                <i class="ph-bold ph-list text-xl lg:hidden"></i>
                {{-- Panel icon for desktop (matches Claude's style) --}}
                <i class="ph-bold ph-sidebar-simple text-xl hidden lg:block"></i>
            </button>

            {{-- Breadcrumb --}}
            <nav class="hidden items-center gap-2 text-sm md:flex">
                <a href="{{ url('/') }}" class="text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="relative" x-data="{ open: false }">
                <button type="button"
                    @click="open = !open"
                    class="relative inline-flex items-center justify-center rounded-lg p-2 text-muted-foreground hover:bg-muted hover:text-foreground transition-colors"
                ...
                <div x-show="open"
                    ...
                    <div class="max-h-64 overflow-y-auto">
                        <a href="#" class="flex gap-3 px-4 py-3 hover:bg-muted transition-colors">
                    ...
                    <div class="border-t border-border p-2">
                        <a href="{{ url('/notifications') }}" class="block rounded-lg px-3 py-2 text-center text-sm font-medium text-primary hover:bg-muted transition-colors">
            ...
            <div class="relative" x-data="{ open: false }">
                <button type="button"
                    @click="open = !open"
                    class="flex items-center gap-3 rounded-lg p-1.5 hover:bg-muted transition-colors"
                ...
                <div x-show="open"
                    ...
                    {{-- Menu Items --}}
                    <div class="py-1">
                        <a href="{{ url('/profile') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                            <i class="ph-bold ph-user text-lg text-muted-foreground"></i>
                            My Profile
                        </a>
                        <a href="{{ url('/profile/edit') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                            <i class="ph-bold ph-pencil-simple text-lg text-muted-foreground"></i>
                            Edit Profile
                        </a>
                        <a href="{{ url('/settings/account') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                            <i class="ph-bold ph-gear text-lg text-muted-foreground"></i>
                            Account Settings
                        </a>
                        <a href="{{ url('/settings/security') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                            <i class="ph-bold ph-lock text-lg text-muted-foreground"></i>
                            Security
                        </a>
                        <a href="{{ url('/settings/notifications') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                    ...
                    <div class="border-t border-border py-1">
                        <a href="{{ url('/articles/create') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                            <i class="ph-bold ph-plus-circle text-lg text-muted-foreground"></i>
                            New Article
                        </a>
                        <a href="{{ url('/logs/user-activity') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                    ...
                    {{-- Help & Support --}}
                    <div class="border-t border-border py-1">
                        <a href="{{ url('/help') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                            <i class="ph-bold ph-question text-lg text-muted-foreground"></i>
                            Help & Support
                        </a>
                        <a href="{{ url('/docs') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                            <i class="ph-bold ph-book-open text-lg text-muted-foreground"></i>
                            Documentation
                        </a>
                        <a href="{{ url('/keyboard-shortcuts') }}" class="flex items-center justify-between px-4 py-2 text-sm text-foreground hover:bg-muted transition-colors">
                            <div class="flex items-center gap-3">
                    ...
                    {{-- Logout --}}
                    <div class="border-t border-border py-1">
                        <a href="{{ url('/logout') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-destructive hover:bg-destructive/10 transition-colors">
