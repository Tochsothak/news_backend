...
@section('content')
    <div class="mx-auto max-w-7xl">
        ...
        {{-- Stats Grid: 2 cols on mobile/tablet, 4 cols on desktop --}}
        <div class="mb-4 grid grid-cols-2 gap-3 sm:mb-6 sm:gap-4 lg:grid-cols-4">
            ...
            <div class="rounded-lg border border-border bg-card p-4 sm:p-6">
                <div class="flex items-start justify-between gap-2">
                    ...
                    <div
                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-info/10 sm:h-12 sm:w-12">
        ...
        {{-- Main Content Grid: Switches to 3 columns ONLY on xl (1280px+) --}}
        <div class="grid gap-4 sm:gap-6 xl:grid-cols-3">

            {{-- Left Column: Charts & Tables --}}
            <div class="flex flex-col gap-4 sm:gap-6 xl:col-span-2">
                ...
                <div class="rounded-lg border border-border bg-card p-4 sm:p-6">
                    ...
                    {{-- Chart Placeholder --}}
                    <div
                        class="flex h-48 items-end justify-between gap-1 rounded-lg bg-muted/30 p-3 sm:h-64 sm:gap-2 sm:p-4">
                        <div class="flex h-full flex-1 flex-col justify-end gap-1 hover:opacity-80 transition-opacity">
                ...
                <div class="rounded-lg border border-border bg-card overflow-hidden">
                    ...
                    {{-- Mobile Card View (Hidden on iPad/lg and up) --}}
                    <div class="divide-y divide-border lg:hidden">
                        <div class="p-4 sm:p-6">
                            <div class="flex items-start gap-3 sm:gap-4">
                                <div class="h-12 w-12 shrink-0 rounded-lg bg-muted object-cover sm:h-14 sm:w-14"></div>
                                <div class="min-w-0 flex-1">
                                    <p class="line-clamp-2 text-sm font-medium text-foreground sm:text-base">Breaking: New
                                        Tech Innovation Announced</p>
                                    <p class="mt-0.5 text-xs text-muted-foreground sm:text-sm">Dec 24, 2025 • John Doe</p>
                        ...
                        <div class="p-4 sm:p-6">
                            <div class="flex items-start gap-3 sm:gap-4">
                                <div class="h-12 w-12 shrink-0 rounded-lg bg-muted object-cover sm:h-14 sm:w-14"></div>
                                <div class="min-w-0 flex-1">
                                    <p class="line-clamp-2 text-sm font-medium text-foreground sm:text-base">Sports:
                                        Championship Finals Results</p>
                                    <p class="mt-0.5 text-xs text-muted-foreground sm:text-sm">Dec 23, 2025 • Jane Smith
                                    </p>
                                    <div class="mt-2 flex flex-wrap items-center gap-2">
                                        <span
                        ...
                        <div class="p-4 sm:p-6">
                            <div class="flex items-start gap-3 sm:gap-4">
                                <div class="h-12 w-12 shrink-0 rounded-lg bg-muted object-cover sm:h-14 sm:w-14"></div>
                                <div class="min-w-0 flex-1">
                                    <p class="line-clamp-2 text-sm font-medium text-foreground sm:text-base">Economy:
                                        Market Update This Week</p>
                                    <p class="mt-0.5 text-xs text-muted-foreground sm:text-sm">Dec 23, 2025 • Mike Johnson
                                    </p>
                                    <div class="mt-2 flex flex-wrap items-center gap-2">
                                        <span
                    ...
                    {{-- Desktop & Tablet Table View (Shows on 'lg' and up) --}}
                    <div class="hidden overflow-x-auto lg:block">
                        <table class="w-full text-left text-sm">
                            <thead>
                                <tr
                                    class="border-b border-border bg-muted/30 text-xs uppercase tracking-wider text-muted-foreground">
                                    <th class="whitespace-nowrap px-6 py-3 font-semibold">Article</th>
                                    <th class="whitespace-nowrap px-6 py-3 font-semibold">Category</th>
                                    <th class="whitespace-nowrap px-6 py-3 font-semibold">Author</th>
                                    <th class="whitespace-nowrap px-6 py-3 font-semibold">Status</th>
                                    <th class="whitespace-nowrap px-6 py-3 font-semibold text-right">Views</th>
                                </tr>
                            </thead>
                                ...
                                <tr class="transition-colors hover:bg-muted/30">
                                    <td class="whitespace-nowrap px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="h-10 w-10 shrink-0 rounded-lg bg-muted object-cover"></div>
                                            <div class="max-w-50 xl:max-w-75">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-foreground">2,345</td>
                                </tr>
                                <tr class="transition-colors hover:bg-muted/30">
                                    <td class="whitespace-nowrap px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="h-10 w-10 shrink-0 rounded-lg bg-muted object-cover"></div>
                                            <div class="max-w-50 xl:max-w-75">
                                                <p class="truncate text-sm font-medium text-foreground">Sports:
                                                    Championship Finals Results</p>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-foreground">1,876</td>
                                </tr>
                                <tr class="transition-colors hover:bg-muted/30">
                                    <td class="whitespace-nowrap px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="h-10 w-10 shrink-0 rounded-lg bg-muted object-cover"></div>
                                            <div class="max-w-50 xl:max-w-75">
                                                <p class="truncate text-sm font-medium text-foreground">Economy: Market
                                                    Update This Week</p>
                                                <p class="text-xs text-muted-foreground">Dec 23, 2025</p>
                                            </div>
                                        </div>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-muted-foreground">—</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="rounded-lg border border-border bg-card">
                    ...
                    <div class="divide-y divide-border">
                        <div class="flex gap-3 p-4 sm:gap-4 sm:p-6">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="mt-1 text-xs text-muted-foreground sm:text-sm">Great article! Really enjoyed
                                    reading this piece about the new technology trends...</p>
                        ...
                        <div class="flex gap-3 p-4 sm:gap-4 sm:p-6">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="mt-1 text-xs text-muted-foreground sm:text-sm">This is very informative. Would
                                    love to see more content like this in the future!</p>
                                <p class="mt-1.5 text-xs text-muted-foreground sm:mt-2">
                                    On: <a href="#" class="text-primary hover:underline">Sports: Championship
                                        Finals</a>
                                </p>
                                <div class="mt-2 flex flex-wrap gap-2 sm:mt-3">
                                    <button
                    ...
                    <div class="border-t border-border p-3 sm:p-4">
                        <a href="{{ url('/comments/pending') }}"
                            class="flex items-center justify-center gap-1 text-sm font-medium text-primary hover:text-primary/80 transition-colors">
            ...
            {{-- Stays a 2x2 grid on md and lg, only switches to a vertical column on xl (1280px+) --}}
            <div class="grid gap-4 sm:gap-6 md:grid-cols-2 xl:flex xl:flex-col">
                ...
                <div class="rounded-lg border border-border bg-card p-4 sm:p-6">
                    ...
                    <div class="space-y-3 sm:space-y-4">
                        ...
                        <div class="flex gap-2 sm:gap-3">
                            ...
                            <div class="min-w-0">
                                <p class="text-xs text-foreground sm:text-sm"><span class="font-medium">5 new
                                        comments</span> need approval</p>
                ...
                <div class="rounded-lg border border-border bg-card p-4 sm:p-6">
                    ...
                    <div class="grid grid-cols-3 gap-2 rounded-lg bg-muted/50 p-2 sm:p-3">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-[10px] text-muted-foreground sm:text-xs">Docs</p>
                        </div>
                    </div>
